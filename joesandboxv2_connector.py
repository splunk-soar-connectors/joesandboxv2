...
if __name__ == '__main__':
    ...
    if username and password:
        try:
            ...
            r = requests.get("https://127.0.0.1/login", verify=verify, timeout=JOE_DEFAULT_REQUEST_TIMEOUT)
            ...
            r2 = requests.post("https://127.0.0.1/login", verify=verify, data=data, headers=headers, timeout=JOE_DEFAULT_REQUEST_TIMEOUT)
